 ...
 * tags:
 *   name: Rates - Vendor
 *   description: Vendor API endpoints for viewing vendor ratings
 */

/**
 * @swagger
 * /api/v1/vendor/vendors/{vendorId}/rates:
 *   get:
 *     summary: Get all ratings for vendor
 *     description: Retrieve all ratings for the vendor with pagination support
 *     tags: ["Rates - Vendor"]
 *     parameters:
 *       - name: vendorId
 *         in: path
...
/**
 * @swagger
 * /api/v1/vendor/vendors/{vendorId}/rates/{rateId}:
 *   get:
 *     summary: Get a specific rating by ID
 *     description: Retrieve details of a specific rating for the vendor
 *     tags: ["Rates - Vendor"]
 *     parameters:
 *       - name: vendorId
 *         in: path
